...
?>
    ...
    <div class="container pt-5">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            <h1 class="display-6 mb-3"> Latest Appointment </h1>
        </div>
        <div class="row g-4">
            <?php
                ...
                while($f_e1 = $q_e1->fetch_array()){
                    ...
                    $original_date_time = $f_e1['appointment_date'];
                    $formatted_date = date("l, F j, Y", strtotime($original_date_time));
                    $formatted_time = date("g:i A", strtotime($original_date_time));

                    // Get services
                    $appointment_services = explode(",", $appointment_desc); // Assuming this is a comma-separated string
                    $services_display = [];
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="service-item">
                    ...
                    <h5 class="mb-3" style="text-transform:capitalize;"><?php echo $f_e1['appointment_status']; ?></h5>
                    <p class="mb-4"><?php echo "<strong>Services</strong>: " . implode(", ", $services_display) . "<br><strong>Date</strong>: " . $formatted_date . "<br><strong>Time</strong>: " . $formatted_time; ?>
                    <?php 
                        $q2 = $conn->query("SELECT COUNT(*) AS count_id FROM `dental_history` WHERE `appointment_desc` = '$appointment_id'");
                        $f2 = $q2->fetch_array();
                        if ($f2['count_id'] >= 1) {
                            $q4 = $conn->query("SELECT * FROM `dental_history` WHERE `appointment_desc` = '$appointment_id'");
                            $f4 = $q4->fetch_array();
                    ?> 
            ...
            <div class="modal fade" id="checkModal<?php echo $f_e1['appointment_id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <center><img src="admin/Chart/<?php echo $f4['dental_file'];?>.jpg" style="width:450px;"></center>
                        </div>
                        <div class="modal-footer">
                            <button class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close">Close</button>
                        </div>
