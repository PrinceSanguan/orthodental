...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light elevation-4" style="background-color: #f8f9fa; border-right: 1px solid #ccc;">
    ...
    <div class="sidebar">
        ...
        </div><div style="text-primary text-uppercase font-weight-bold text-center">
  ...
  <div class="head">
    ...
    <div class="content-header">
       <div class="row mb-2">
		...
		<a href="section-management.php"  class = "btn-primary btn-m btn" >Schedule Management</a>
		...
		<a href="section-excel.php?nav=Cancelled"  class = "btn-warning btn-m btn float-right" >Download</a>
			...
			<div class='card-header py-3' style="background-color:navy;">
              <h6 class="m-0 font-weight-bold" style="color:white;" >Schedule Management
	   ...
	   ?>
            ...
            <td><?php echo date("l, F j, Y", strtotime($cleaned_date_time))?></td>
						<td class="printPageButton"; ><a href="section-management.php?data=<?php echo $f_e['appointment_desc_id'];?>" class="btn btn-danger">Delete</a></td>
					</tr>
						<?php
						}	
					if(isset($_GET['data'])){
