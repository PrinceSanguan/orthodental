  ...
  <div class="head">
    ...
    <div class="content-header">
       <div class="row mb-2">
		...
		<a href="section-success.php"  class = "btn-primary btn-m btn" >Completed</a>
	   ...
	   ?>
            ...
            <td><?php echo $time_12hr_format?></td>	
						...
						<td class="printPageButton";><a href="view-history.php?id=<?php echo $u_id_user?>&history=<?php echo $f_e['appointment_desc_id']?>" class="btn btn-info">Update History</a></td>
