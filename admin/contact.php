    ...
    <div class="content-header">
       <div class="row mb-2">
	    ...
	    <div class="printPageButton"> 
          ...
          // $q_e = $conn->query("
          //     SELECT ua.u_id, ua.fname, ua.mname, ua.lname, ua.email
          //     FROM `user_account1` ua
          //     JOIN `chat` c ON ua.u_id = c.chat_user_id
          //     WHERE ua.u_id != '11'
          // ");
	   ...
	   ?>
					<tr>
						...
						<td >
						    ...
						    <?php
						        $chat_u_id = $f_e['u_id'];
                                $q1 = $conn->query("SELECT count(*) as count_msg FROM `chat` WHERE `chat_reps_u_id` = '1' AND `view`='' AND `chat_to`='$chat_u_id'") or die(mysqli_error($conn));
                                $f1 = $q1->fetch_array();
