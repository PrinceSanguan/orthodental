  ...
  <div class="content-wrapper">
	    ...
	    <form method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" style="margin-top:50px;">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group" id="teethContainer">
                        ...
                        <select class="form-control" name="teeth" id="teeth" multiple>
                    ...
                    <div class="form-group">
                    <label>Braces Location</label>
                      <select class="form-control form-control-user" name="teeth">
                      <option value="" disabled selected>--Select--</option>
                          <option value="brace_upper">Upper Brace</option>
                          <option value="brace_lower">Lower Brace</option>
                      </select>


                      <input type="hidden" class="form-control form-control-user" name="user_data" value="<?php echo htmlspecialchars($_GET['id']); ?>" style="text-transform:capitalize;">
                      <input type="hidden" class="form-control form-control-user" name="history_data" value="<?php echo htmlspecialchars($_GET['history']); ?>" style="text-transform:capitalize;">
                  </div>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
          ...
          var teethContainer = document.getElementById('teethContainer'); // Teeth Operated
          var bracesLocationField = document.querySelector('select[name="teeth"]:not(#teeth)').parentElement; // Braces Location container

          // Function to handle the display of fields based on selection
          function handleBraceAdjustmentChange() {
              var selectedValue = braceAdjustmentSelect.value;

              if (selectedValue === 'teeth services') {
                  // Hide Braces Location only
                  bracesLocationField.style.display = 'none';
                  teethContainer.style.display = 'block'; // Show Teeth Operated
              } else if (selectedValue === 'brace adjument only') {
                  // Hide Teeth Operated, show Braces Location
                  bracesLocationField.style.display = 'block';
                  teethContainer.style.display = 'none';
              } else if (selectedValue === 'braces and teeth services') {
                  // Show both fields
                  bracesLocationField.style.display = 'block';
...
?>
			...
			<div class='card-header py-3' style="background-color:navy;">
              <h6 class="m-0 font-weight-bold" style="color:white;" >Patient List
...
if ($selectedValue == "brace_lower") {
  echo "Lower Teeth Brace<br>";
}
if ($selectedValue == "brace_upper") {
  echo "Upper Teeth Brace<br>";
}
						    ?>
						</td>
