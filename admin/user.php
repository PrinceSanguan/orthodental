...
<div class="wrapper">
  ...
  <div class="head">
    ...
    <button class="btn btn-primary" onclick="history.back()">Go Back</button>
			...
			<div class='card-header py-3 ' style="background-color:navy;">
              <h6 class="m-0 font-weight-bold" style="color:white;" >User Management
  ...
  <table width="100%" class="display" cellspacing="0">
                 ...
                 <tbody>		
	            <?php	
					$q_e = $conn->query("SELECT * FROM `user_account1` WHERE `u_id`!='11' ORDER BY `u_id` DESC");
	   ...
	   ?>
					<tr>
						...
						<td class="printPageButton">
						    ...
						    <a href="user.php?delete_id=<?php echo $f_e['u_id'];?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
						</td>	
        ...
        <?php
          if (isset($_GET['delete_id'])) {
              ...
              $sql_delete = "DELETE FROM user_account1 WHERE `u_id`='$user_id'";
